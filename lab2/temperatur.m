...
[x_1, T_1] = stav(n_vals(4), 3200, 200);
[x_2, T_2] = stav(n_vals(4), 2800, 200);
[x_3, T_3] = stav(n_vals(4), 3000, 210);
[x_4, T_4] = stav(n_vals(4), 3000, 190);

error_1 = abs(max(T_reference) - max(T_1));
error_2 = abs(max(T_reference) - max(T_2));
error_3 = abs(max(T_reference) - max(T_3));
error_4 = abs(max(T_reference) - max(T_4));

mean_error = max([error_1 error_2 error_3 error_4]);
